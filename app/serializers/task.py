...
import json
from app.models.task import Task, QuestionsCriteria,ParticipantTask,AssingJudgeToTask,ParticipantTaskdocs,TaskGrading,TaskGrades
...
class TaskSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields= ("id","title","description","submission_due_date","grade_due_date","max_no_of_judge","created_on","created_by","questions","assing_to","status","task_grading","release_score_to_participant")
...
class TaskDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields= ("id","title","description", "submission_due_date","grade_due_date","max_no_of_judge",
                 "created_on","created_by","questions","assing_to","status")
