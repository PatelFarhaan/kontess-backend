...
class TeamSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Team
        fields = ('id', 'name', 'logo', 'description','portfolio',"partipants","team_mentor","created_by","team_track")
        read_only_fields = ('id','created_by','team_mentor','partipants',"team_track")
